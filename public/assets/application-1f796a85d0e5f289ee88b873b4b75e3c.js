...
(function() {
  $(function() {
    ...
    $("#group-finder-form").on("ajax:error", function(event) {
      return $.jGrowl("Group not found, please try again", {
        position: "center"
      });
    });
    ...
    $("#rsvp-modal").on("ajax:error", "#group-rsvp-form", function(event) {
      $("#rsvp-modal").modal("hide");
...
(function() {
  $(function() {
    $("#rsvp-modal").on("change", "input:checkbox", function(event) {
      var checkboxes, checked, inviteGroup, numInvited, unchecked;
      ...
      return unchecked.prop("disabled", checked >= numInvited);
    });
    return $("#rsvp-modal").on("shown", function(event) {
      ...
      return inviteGroups.each(function(index, inviteGroup) {
        var checkboxes, checked, numInvited, unchecked;
        numInvited = $(inviteGroup).data("invited");
        checkboxes = $(inviteGroup).find("input:checkbox");
        checked = checkboxes.filter(":checked").length;
        unchecked = checkboxes.filter(":not(:checked)");
